...
public class VolunteerProfileActivity extends AppCompatActivity {
    ...
    private TextView profileNameTextView; // --------- this will give me the name
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // editTextName = (EditText)findViewById(R.id.et_username);
        profilePicImageView = findViewById(R.id.UserImage);
        profileNameTextView = findViewById(R.id.Name);
       ...
       /* storageReference.child(firebaseAuth.getUid()).child("Images").child("Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(VolunteerProfileActivity.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    /*
